...
<body id="page-top">
  ...
  //Fetch all data mahasiswa from database
                  ...
                  <table class="table table-stripped">
                    ...
                    <tbody>
                      ...
                      while ($data_mahasiswa = mysqli_fetch_array($result_mahasiswa)) {
                        ...
                        echo "<td>".$data_mahasiswa['email']."</td>";
                        ...
                        echo "<td> <a class='btn btn-success' href='edit_mahasiswa.php?nip=$data_mahasiswa[nrp]'>Edit</a> <a class='btn btn-danger' onclick = 'deleteConfirm(event)' href='delete_mahasiswa.php?nip=$data_mahasiswa[nrp]'><i class='fas fa-trash fa-fw'></i>Delete</a></td></tr>";
                      }
                        ?>
                    </tbody>
                  </table>
